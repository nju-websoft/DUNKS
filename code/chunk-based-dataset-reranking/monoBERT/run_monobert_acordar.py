...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", default='/path_to_model', type=str)
    ...
    parser.add_argument("--train_dir_path", default='./data/acordar/metadata/', type=str)
    parser.add_argument("--test_dir_path", default='./data/acordar/metadata/', type=str)
    parser.add_argument("--test_qrels_path", default='./data/qrels/acordar_test_qrels.json', type=str)
    parser.add_argument("--results_save_path", default='./results/', type=str)
    parser.add_argument("--max_train_pos", default=5, type=int)
    parser.add_argument("--max_train_neg", default=5, type=int)
